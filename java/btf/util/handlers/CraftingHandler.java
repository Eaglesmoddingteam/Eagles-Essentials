...
public class CraftingHandler {
	...
	public static void RegisterRecipes() {
		 ...
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "woodengear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.woodGear), "PSP","SAS","PSP", 'P', Item.getItemFromBlock(Blocks.PLANKS), 'S', Items.STICK, 'A', (Item) ItemInit.tin);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "brassgear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.brassGear), "PSP","SAS","PSP", 'P', (Item) ItemInit.brass, 'S', Items.STICK, 'A', (Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "bronzegear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.bronzeGear), "PSP","SAS","PSP", 'P',(Item)  ItemInit.bronze, 'S', Items.STICK, 'A', (Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "cobaltgear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.cobaltGear), "PSP","SAS","PSP", 'P',(Item)  ItemInit.cobalt, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "coppergear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.copperGear), "PSP","SAS","PSP", 'P', (Item) ItemInit.copper, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "impossiblealloygear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.impossibleAlloyGear), "PSP","SAS","PSP", 'P',(Item) ItemInit.impossibleAlloy, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "irongear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.ironGear), "PSP","SAS","PSP", 'P', Items.IRON_INGOT, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "leadgear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.leadGear), "PSP","SAS","PSP", 'P', (Item) ItemInit.lead, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "goldgear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.goldGear), "PSP","SAS","PSP", 'P', Items.GOLD_INGOT, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
		 GameRegistry.addShapedRecipe(new ResourceLocation(Vars.MOD_ID + ":" + "platinumgear"), new ResourceLocation(Vars.MOD_ID + ":" + "gearupgrade"), new ItemStack(ItemInit.platinumGear), "PSP","SAS","PSP", 'P',(Item)  ItemInit.platinum, 'S', Items.STICK, 'A',(Item) ItemInit.woodGear);
